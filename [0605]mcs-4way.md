...
|--------|------|------|------|------|
| Edge IoU ↑ | 0.0640 | x | 0.0628 | x |
| Chamfer Dist ↓ | 4.7013 | x | 4.8089 | x |
| Sketch LPIPS ↓ | 0.7599 | x | 0.7567 | x |
| Hair FID ↓ | N/A | x | N/A | x |
| LPIPS (GT) ↓ | 0.2973 | x | 0.3066 | x |
| SSIM (GT) ↑ | 0.5893 | x | 0.5866 | x |
| PSNR (GT) ↑ | 11.6486 | x | 11.5611 | x |
| Boundary FID ↓ | N/A | x | N/A | x |
| Boundary LPIPS ↓ | 0.0197 | x | 0.0220 | x |
| Face LPIPS ↓ | 0.0033 | x | 0.0033 | x |
| ArcFace Cos ↑ | 0.6860 | x | 0.7014 | x |
